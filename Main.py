...
if st.button("🔍 Predict Dropout Risk"):
    ...
    if prediction == False and all([
        ...
        st.session_state.grade >= 5.0,
        st.session_state.income > 8000,
        st.session_state.support,
        st.session_state.internet
    ]):
...
<div style='display: flex; justify-content: space-between; padding: 20px; color: gray; font-size: 14px;'>
    <div style="flex: 1; text-align: left;">
        <b>The original model was made in Jupyter Notebook. A copy of that model was deployed in this webpage.</b><br>
        Project Drive Link: <a href='https://drive.google.com/drive/folders/1zJwekyLfYK5GPeopXmzUofm55B7vIzZx' target='_blank'>DropShield AI - Google Drive</a>
    </div>
